        ...
        <div class="row g-0">
            ...
            <div class="col-md-3 col-lg-2 sidebar d-none d-md-block">
                ...
                <ul class="nav flex-column">
                    ...
                    <!-- SECTION : GÉRER LES MENUS (Couleur corrigée pour fond sombre) -->
                    <li class="nav-item mt-2">
                        <span class="nav-link fw-bold pb-1" style="font-size: 0.8rem; color: rgba(255, 255, 255, 0.5) !important; cursor: default; background: none !important; text-transform: uppercase; letter-spacing: 0.5px;">
                            <i class="fas fa-utensils me-1"></i> Gérer les Menus
                        </span>
                        <ul class="nav flex-column ms-3 ps-2 border-start border-secondary gap-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link py-1 {{ Request::routeIs('admin.allergenes.index') ? 'active' : '' }}" href="{{ route('admin.allergenes.index') }}">
                                    <i class="fas fa-exclamation-triangle" style="font-size: 0.85rem;"></i> Menu Tags
                                </a>
                            </li>
                            <li class="nav-item">
