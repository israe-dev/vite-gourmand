    ...
    <div class="row g-4">
            ...
            <div class="card p-4 border-0 shadow-sm rounded-4">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="Saisir votre nom" readonly bg-light>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Prénom</label>
                        <input type="text" class="form-control" value="Saisir votre prénom" readonly bg-light>
                    </div>
                    <div class="col-md-10">
                        <label class="form-label small text-muted">Téléphone GSM</label>
                        <input type="text" class="form-control" value="06 00 00 00 00" readonly bg-light>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" placeholder="Adresse complète (ex: 12 Rue Sainte-Catherine, 33000 Bordeaux)" required>
                    ...
                    <div class="col-md-6 mt-4">
                        ...
                        <input type="number" class="form-control" min="10" value="10" style="border: 2px solid var(--vert-sauge);" required>
        ...
        <div class="col-lg-5">
            <div class="card p-4 border-0 shadow-sm rounded-4 text-white" style="background-color: var(--marron-doux);">
                ...
                <button class="btn w-100 py-3 rounded-pill fw-bold" style="background-color: var(--orange-brand); color: white; border: none;">
